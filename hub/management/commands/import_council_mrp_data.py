...
class Command(MultipleAreaTypesMixin, BaseImportFromDataFrameCommand):
    ...
    data_sets = {
        ...
        "council_support-local-renewable": {
            "defaults": {
                **survation_defaults,
    ...
    del data_sets["council_cc_high"]["defaults"]["subcategory"]
