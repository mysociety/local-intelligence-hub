from strawberry_django_dataloaders.views import DataloaderAsyncGraphQLView, DataloaderContext
...
class CustomSchemaView(DataloaderAsyncGraphQLView):
    async def get_context(self, request, response) -> HubDataLoaderContext:
        ...
        setattr(context, "area_coordinate_loader", DataLoader(load_fn=get_bulk_postcode_geo_from_coords))
        return context