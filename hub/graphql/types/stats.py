        ...
        for col in numerical_keys:
            ...
            calculated_column_aggop = next(
                (
                    ...
                    for c in post_calcs
                    if c.name == col and c.aggregation_operation is not AggregationOp.Guess
                ),
                None,
            ) or next(
                (
            ...
            simple_asserted_aggop = conf.aggregation_operation if (
                conf.aggregation_operation and conf.aggregation_operation is not AggregationOp.Guess
            ) else None
            default_aggop = AggregationOp.Mean if col in percentage_keys else AggregationOp.Sum
