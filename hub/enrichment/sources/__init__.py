...
enrichment_data_sources = {
  "postcodes.io": {
    ...
    "sourcePaths": [
      ...
      },
      {
        ...
        "description":
          "See description of parliamentary_constituency_2025 field.",
      },
      {
        "value": "codes.ward",
  ...
  "electoral_commission_postcode_lookup": {
    ...
    "postcode_request": electoral_commision_postcode_lookup,
    "sourcePaths": [
      {
        "value": "dates[0].ballots[0].ballot_title",
        "label": "Next Election"
      },
      {
        "value": "dates[0].ballots[0].date",
        "label": "Next Polling Date"
      },
      {
