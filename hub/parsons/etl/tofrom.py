...
class ToFrom(object):
    ...
    def to_sftp_csv(
        ...
        **csvargs,
        ...
        from hub.parsons.sftp import SFTP
    ...
    def to_s3_csv(
        ...
        **csvargs,
        ...
        # Put the file on S3
        from hub.parsons.aws import S3
    ...
    def to_gcs_csv(
        ...
        **csvargs,
        ...
        from hub.parsons.google.google_cloud_storage import GoogleCloudStorage
    ...
    def to_redshift(
        ...
        **copy_args,
        ...
        from hub.parsons.databases.redshift import Redshift
    ...
    def to_postgres(
        ...
        **copy_args,
        ...
        from hub.parsons.databases.postgres import Postgres
    ...
    def to_civis(
        ...
        **civisargs,
        ...
        from hub.parsons.civis.civisclient import CivisClient
