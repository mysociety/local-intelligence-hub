                ...
                <div className="flex flex-row justify-between items-center basis-1/2">
                  <div>
                    ...
                    <div className="flex flex-col">
                      <li className="font-PPRightGrotesk">
                  ...
                  <div className="flex items-center">
                    <Button className="font-IBMPlexSans text-base">
                      Upload data
                    </Button>
                    <p>or</p>
                    <Input
                      type="text"
                      className="font-IBMPlexSans text-base"
                      placeholder=" Enter postcode/constituency"
                    />
                  </div>
                </div>
                  ...
                  <li className="flex">
                    ...
                    <Collapsible>
                      <CollapsibleTrigger>
                        ...
                        >
                          <path
                            d="M1.74599 0.12793L5.09712 3.47176L8.44825 0.12793L9.47769 1.15736L5.09712 5.53793L0.716553 1.15736L1.74599 0.12793Z"
                            fill="white"
                          />
                        </svg>
                      </CollapsibleTrigger>
