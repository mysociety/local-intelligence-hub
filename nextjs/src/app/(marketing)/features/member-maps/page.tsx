import MarketingPageHeader from "@/components/marketing-pages-header";
...
export default function MemberMaps() {
  ...
  return (
    <>
      <MarketingPageHeader
      featureName="Member Maps"
        heading={<>See where your <span className="text-hXlgPP font-PPRightGrotesk">members</span> are and reach them easily</>}
      ...
      <div className="py-10">
        <div className="relative">
          <Image src="/mapping-screenshot.png"
            alt="test"
            width="0"
            height="0"
            sizes="100vw"
        ...
        <div className="flex flex-row gap-4">
          ...
          <Card>
            <CardHeader>
              <CardTitle className="mb-3 px-6 pt-6">Access contact information</CardTitle>
              <CardDescription className="text-sm text-meepGray-400 px-6 pb-6">Reach out to your members with ease by configuring your member list to show contact information.</CardDescription>
            </CardHeader>
          </Card>
        </div>
        <div className="py-10 mt-20 border-t border-meepGray-700 flex flex-col items-center gap-10">
          <h2 className="text-hLg">
            Why did we build this?
          </h2>
          <div className="text-meepGray-300 text-lg space-y-8 flex flex-col items-center">
            <p className="max-w-prose">Mapped is built for organisations and organisers trying to do good in the UK. We facilitated multiple workshops that we designed for a cohort of organisations which included a comprehensive discovery process.</p>
            <Image
