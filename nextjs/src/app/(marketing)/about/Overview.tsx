...
export default function AboutOveriew() {
    ...
    return (
        <div className="flex flex-col items-center">
            <MarketingPageHeader
                heading={<><span className="md:text-hXlgPP text-hLgPP font-PPRightGrotesk">More </span>than just maps</>}
                    ...
                    <div className="flex flex-col gap-4 p-10">
                        <Card className="md:max-w-lg p-6">
                            <CardHeader>
                                ...
                                <CardDescription className="text-sm text-meepGray-400">Mapped liberates membership data from static, siloed databases, enabling aligned organisations and campaigns to work together to build collective power.</CardDescription>
                            </CardHeader>
                        </Card>
                        <Card className="md:max-w-lg p-6">
                            <CardHeader>
                                <CardTitle className="mb-3">Transforming information into intelligence</CardTitle>
                                <CardDescription className="text-sm text-meepGray-400">Organisers can use Mapped to create high-dimensional pictures out of multiple information sources, spark creative thoughts, and develop their campaign strategy based on real data.</CardDescription>
                            </CardHeader>
                        </Card>
                        <Card className="md:max-w-lg p-6">
                            <CardHeader>
                                <CardTitle className="mb-3">Radical collaboration</CardTitle>
                                <CardDescription className="text-sm text-meepGray-400">Mapped is a real-time, multiplayer decision-making tool for grounding organisational tactics in real information, facilitating radically open collaboration from both organisers, members and other allies.</CardDescription>
                            </CardHeader>
                        </Card>
                    </div>
                </div>
                <div className="flex flex-col gap-4 place-content-center items-center">
                    ...
                    <div className="grid md:grid-cols-2 grid-cols-1 gap-4 pb-20">
                        <Card className="max-w-lg">
                            <CardHeader>
                                <CardTitle className="mb-3 px-6 pt-6 text-hMd">Built by Common Knowledge</CardTitle>
                            </CardHeader>
                            <CardDescription className="text-meepGray-400 px-6">We are a not-for-profit worker cooperative of technologists, designers, researchers and facilitators. We work directly with grassroots organisers, using our digital expertise to multiply their impact and capacity.
                            </CardDescription>
                            <CardFooter className="mt-6 px-6 pb-6">
                                <Link href="https://commonknowledge.coop/" className="bg-meepGray-600 p-6 flex rounded-md">
                                    <CommonKnowledgeLogo />
                                </Link>
                            </CardFooter>
                        ...
                        <Card className="max-w-lg">
                            <CardHeader>
                                <CardTitle className="mb-3 px-6 pt-6 text-hMd">Funded by Civic Power Fund & JRRT</CardTitle>
                            </CardHeader>
                            <CardDescription className="text-meepGray-400 px-6">This tool was made possible through the generous support of the Civic Power Fund and the Joseph Rowntree Reform Trust.
                            </CardDescription>
                            <CardFooter className="mt-6 px-6 pb-6 gap-4">
                                <Link href="https://www.civicpower.org.uk/" className="bg-meepGray-600 p-6 rounded-md" >
                                    <CiviPowerFundLogo />
                                </Link>
                                <Link href="https://www.jrrt.org.uk/" className="bg-meepGray-600 p-6 rounded-md">
                                    <JRRTLogo />
                                </Link>
                            </CardFooter>
                    ...
                    <div className="grid grid-cols-2 gap-4 pb-20 max-w-2xl">
                        <Link className="h-full" href={"https://www.gndrising.org/"}>
                            <Card className="h-full max-w-lg bg-meepGray-600 p-6 flex">
                                <Image src="/cohort/GNDRising.png"
                                    alt="test"
                                    width="0"
                                    height="0"
                                    sizes="100vw"
                        ...
                        <Link className="h-full" href={"https://www.pomoc.org.uk/"}>
                            <Card className="h-full max-w-lg bg-meepGray-600 p-6 flex">
                                <Image src="/cohort/pomoc-logo.png"
                                    alt="test"
                                    width="0"
                                    height="0"
                                    sizes="100vw"
                        ...
                        <Link className="h-full" href={"https://justtreatment.org/"}>
                            <Card className="h-full max-w-lg bg-meepGray-600 p-6 flex">
                                <Image src="/cohort/just-treatment.png"
                                    alt="test"
                                    width="0"
                                    height="0"
                                    sizes="100vw"
