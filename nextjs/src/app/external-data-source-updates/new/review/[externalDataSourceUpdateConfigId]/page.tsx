...
import { PageForExternalDataSourceUpdateConfigReviewQuery, PageForExternalDataSourceUpdateConfigReviewQueryVariables } from '@/__generated__/graphql';
...
export default function Page({ params: { externalDataSourceUpdateConfigId }}: { params: { externalDataSourceUpdateConfigId: string }}) {
  ...
  const data = useQuery<PageForExternalDataSourceUpdateConfigReviewQuery, PageForExternalDataSourceUpdateConfigReviewQueryVariables>(GET_UPDATE_CONFIG, {
    variables: {
  ...
  return (
    <div className='space-y-7'>
      ...
      {data.loading || !data.data ? (
        ...
        <ExternalDataSourceUpdateConfigCard updateConfig={data.data.externalDataSourceUpdateConfig} />
      )}
