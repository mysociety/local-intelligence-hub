...
import { BatchJobProgress, ProcrastinateJobStatus } from "@/__generated__/graphql";
import { LoadingIcon } from "./ui/loadingIcon";
import { MessageCircleHeart, MessageCircleWarning } from "lucide-react";

export function BatchJobProgressReport ({ batchJobProgress, pastTenseVerb = 'Completed' }: { 
