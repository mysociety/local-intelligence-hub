...
export function UpdateConfigForm ({
  ...
  onSubmit: (data: MutationUpdateExternalDataSourceUpdateConfigArgs['data']) => void,
  initialData?: Partial<MutationUpdateExternalDataSourceUpdateConfigArgs['data']>,
  saveButtonLabel?: string,
  children?: React.ReactNode
}) {
  const form = useForm<MutationUpdateExternalDataSourceUpdateConfigArgs['data']>({
