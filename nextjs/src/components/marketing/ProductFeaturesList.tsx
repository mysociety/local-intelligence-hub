...
import { ExternalLink, Layers, Repeat } from "lucide-react";
            ...
            <Link href="/features/member-maps">
                <Card className='bg-meepGray-800 border-meepGray-700 hover:bg-meepGray-700 transition h-full '>
                    <div className='block p-4'>
                        ...
                        <CardDescription className="text-sm text-meepGray-400">Visualise your members geographically to help plan your campaigns.</CardDescription>
                    </div>
                    <CardContent>
                        <Image src="/feature-mapping-thumbnail.png"
                            alt="test"
                            width="0"
                            height="0"
                            sizes="100vw"
            ...
            <Link href="/features/data-enrichment">
                <Card className='bg-meepGray-800 border-meepGray-700 hover:bg-meepGray-700 transition h-full '>
                    <div className='block p-4'>
                        ...
                        <CardDescription className="text-sm text-meepGray-400">Overlay your membership list with useful contextual data.</CardDescription>
                    </div>
                    <CardContent >
                        <Image src="/feature-data-enrichment-thumbnail.png"
                            alt="test"
                            width="0"
                            height="0"
                            sizes="100vw"
            ...
            <Link href="/features/crm-sync">
                <Card className='bg-meepGray-800 border-meepGray-700 hover:bg-meepGray-700 transition h-full '>
                    <div className='block p-4'>
                        ...
                        <CardDescription className="text-sm text-meepGray-400">Instantly sync data between Mapped and your CRM.</CardDescription>
                    </div>
                    <CardContent>
                        <Image src="/feature-crm-sync-thumbnail.png"
                            alt="test"
                            width="0"
                            height="0"
                            sizes="100vw"
