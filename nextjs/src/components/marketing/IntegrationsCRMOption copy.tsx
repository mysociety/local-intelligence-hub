                ...
                <div className="grid grid-rows-3 ">
                    <div className="flex items-end justify-center" >
                        <div className="w-[65%] md:h-[30%] h-[80%] border-x-2 border-t-2 border-brandBlue rounded-t-lg relative">
                            ...
                            <svg className="absolute right-0 bottom-0 -mr-[0.55rem] -mb-0.5 z-20" transform="rotate(-180)" width="16" height="9" viewBox="0 0 16 9" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M8.70711 0.292893C8.31658 -0.0976311 7.68342 -0.0976311 7.29289 0.292893L0.928932 6.65685C0.538408 7.04738 0.538408 7.68054 0.928932 8.07107C1.31946 8.46159 1.95262 8.46159 2.34315 8.07107L8 2.41421L13.6569 8.07107C14.0474 8.46159 14.6805 8.46159 15.0711 8.07107C15.4616 7.68054 15.4616 7.04738 15.0711 6.65685L8.70711 0.292893ZM9 2L9 1L7 1L7 2L9 2Z" fill="#678DE3" />
                            </svg>
                        </div>
                    </div>
                    ...
                    <div className="flex items-start justify-center" >
                        <div className="w-[65%] md:h-[30%] h-[80%] border-x-2 border-b-2 border-brandBlue rounded-b-lg relative">
                            ...
                            <svg className="absolute left-0 top-0 -ml-[0.55rem] -mt-0.5 z-20" width="16" height="9" viewBox="0 0 16 9" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M8.70711 0.292893C8.31658 -0.0976311 7.68342 -0.0976311 7.29289 0.292893L0.928932 6.65685C0.538408 7.04738 0.538408 7.68054 0.928932 8.07107C1.31946 8.46159 1.95262 8.46159 2.34315 8.07107L8 2.41421L13.6569 8.07107C14.0474 8.46159 14.6805 8.46159 15.0711 8.07107C15.4616 7.68054 15.4616 7.04738 15.0711 6.65685L8.70711 0.292893ZM9 2L9 1L7 1L7 2L9 2Z" fill="#678DE3" />
                            </svg>
                        </div>
                    </div>
