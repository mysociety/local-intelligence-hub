...
/** GenericData(id, data_type, data, date, float, int, json, last_update, point, polygon, postcode_data, osm_data, postcode, address, title, description, image, first_name, last_name, full_name, email, phone, start_time, end_time, public_url) */
...
export type EnrichmentLayersQuery = { __typename?: 'Query', externalDataSources: Array<{ __typename?: 'ExternalDataSource', id: any, name: string, geographyColumn?: string | null, geographyColumnType: GeographyTypes, dataType: DataSourceType, crmType: string, fieldDefinitions?: Array<{ __typename?: 'FieldDefinition', label?: string | null, value: string, description?: string | null }> | null }> };
...
export type MapReportLayerAnalyticsQuery = { __typename?: 'Query', mapReport: { __typename?: 'MapReport', id: any, layers: Array<{ __typename?: 'MapLayer', id: string, name: string, customMarkerText?: string | null, source: { __typename?: 'SharedDataSource', id: any, dataType: DataSourceType, organisation: { __typename?: 'PublicOrganisation', name: string } } }> } };
