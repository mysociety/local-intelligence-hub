...
export type AreaExplorerSummaryQuery = { __typename?: 'Query', area?: { __typename?: 'Area', id: string, fitBounds?: any | null, name: string, areaType: { __typename?: 'AreaType', name: string, description: string } } | null };
