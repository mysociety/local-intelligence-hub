...
export type UpdateExternalDataSourceApiKeyMutation = {
  __typename?: 'Mutation'
  updateExternalDataSourceApiKey: boolean
}
...
>
export const UpdateExternalDataSourceApiKeyDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'mutation',
      name: { kind: 'Name', value: 'UpdateExternalDataSourceApiKey' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'id' } },
  ...
  UpdateExternalDataSourceApiKeyMutation,
