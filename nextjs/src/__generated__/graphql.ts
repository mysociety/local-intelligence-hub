...
export type PageForExternalDataSourceUpdateConfigQuery = {
  __typename?: "Query";
  externalDataSourceUpdateConfig: {
    __typename?: "ExternalDataSourceUpdateConfig";
    id: any;
    enabled: boolean;
...
export type UpdateConfigMutation = {
  __typename?: "Mutation";
  updateExternalDataSourceUpdateConfig: {
    __typename?: "ExternalDataSourceUpdateConfig";
    id: any;
    postcodeColumn?: string | null;
    mapping: Array<{
...
export type CheckIfSourceHasConfigQuery = {
  __typename?: "Query";
  externalDataSource: {
    __typename?: "ExternalDataSource";
    id: any;
...
export type CreateUpdateConfigMutation = {
  __typename?: "Mutation";
  createExternalDataSourceUpdateConfig: {
    __typename?: "ExternalDataSourceUpdateConfig";
    id: any;
    postcodeColumn?: string | null;
    mapping: Array<{
...
export type TestAirtableSourceQuery = {
  __typename?: "Query";
  testAirtableSource: boolean;
};
...
export type CreateAirtableSourceMutation = {
  __typename?: "Mutation";
...
export type AllExternalDataSourcesQueryVariables = Exact<{
  [key: string]: never;
}>;

export type AllExternalDataSourcesQuery = {
  __typename?: "Query";
...
export type PageForExternalDataSourceUpdateConfigReviewQuery = {
  __typename?: "Query";
  externalDataSourceUpdateConfig: {
    __typename?: "ExternalDataSourceUpdateConfig";
    id: any;
    ...
    jobs: Array<{ __typename?: "QueueJob"; lastEventAt: any; status: string }>;
  };
};

export type ListUpdateConfigsQueryVariables = Exact<{ [key: string]: never }>;

export type ListUpdateConfigsQuery = {
  __typename?: "Query";
  externalDataSourceUpdateConfigs: Array<{
    __typename?: "ExternalDataSourceUpdateConfig";
    id: any;
    enabled: boolean;
    externalDataSource: {
...
export type LoginMutation = {
  ...
  tokenAuth: {
    ...
    errors?: any | null;
    success: boolean;
    token?: { __typename?: "TokenType"; token: string } | null;
  };
};
...
export type UpdateConfigCardFieldsFragment = {
  ...
  jobs: Array<{ __typename?: "QueueJob"; lastEventAt: any; status: string }>;
} & { " $fragmentName"?: "UpdateConfigCardFieldsFragment" };

export type EnableUpdateConfigMutationVariables = Exact<{
  ID: Scalars["String"]["input"];
}>;

export type EnableUpdateConfigMutation = {
  __typename?: "Mutation";
  enableUpdateConfig: {
    __typename?: "ExternalDataSourceUpdateConfig";
    id: any;
...
export type DisableUpdateConfigMutation = {
  __typename?: "Mutation";
  disableUpdateConfig: {
    __typename?: "ExternalDataSourceUpdateConfig";
    id: any;
...
export type UserTestQuery = {
  __typename?: "Query";
  me: { __typename?: "UserType"; id: string };
};

export const UpdateConfigCardFieldsFragmentDoc = {
  kind: "Document",
  definitions: [
    {
      kind: "FragmentDefinition",
      name: { kind: "Name", value: "UpdateConfigCardFields" },
      typeCondition: {
        kind: "NamedType",
        name: { kind: "Name", value: "ExternalDataSourceUpdateConfig" },
      },
      selectionSet: {
        kind: "SelectionSet",
        selections: [
...
} as unknown as DocumentNode<UpdateConfigCardFieldsFragment, unknown>;
...
export const PageForExternalDataSourceUpdateConfigDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                {
                  kind: "Field",
                  name: { kind: "Name", value: "postcodeColumn" },
                },
                {
                  kind: "Field",
      ...
      variableDefinitions: [
        {
          ...
          type: {
            ...
            type: {
              ...
              name: {
                kind: "Name",
                value: "ExternalDataSourceUpdateConfigInput",
              },
            },
          },
        },
        ...
        selections: [
          {
            ...
            name: {
              kind: "Name",
              value: "updateExternalDataSourceUpdateConfig",
            },
            arguments: [
              {
                kind: "Argument",
...
>;
export const CheckIfSourceHasConfigDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "CheckIfSourceHasConfig" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "ID" } },
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                {
                  kind: "Field",
                  name: { kind: "Name", value: "updateConfigs" },
                  selectionSet: {
                    kind: "SelectionSet",
                    selections: [
                      { kind: "Field", name: { kind: "Name", value: "id" } },
...
>;
export const CreateUpdateConfigDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "CreateUpdateConfig" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
        ...
        selections: [
          {
            ...
            name: {
              kind: "Name",
              value: "createExternalDataSourceUpdateConfig",
            },
            arguments: [
              {
                kind: "Argument",
...
>;
export const TestAirtableSourceDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "TestAirtableSource" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
...
>;
export const CreateAirtableSourceDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "CreateAirtableSource" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
          ...
          type: {
            ...
            type: {
              kind: "NamedType",
              name: { kind: "Name", value: "AirtableSourceInput" },
            },
          },
        },
      ],
...
export const AllExternalDataSourcesDocument = {
  ...
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "AllExternalDataSources" },
      selectionSet: {
        kind: "SelectionSet",
        selections: [
          {
  ...
  AllExternalDataSourcesQueryVariables
>;
export const PageForExternalDataSourceUpdateConfigReviewDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      ...
      name: {
        kind: "Name",
        value: "PageForExternalDataSourceUpdateConfigReview",
      },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
  ...
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "ListUpdateConfigs" },
      selectionSet: {
        kind: "SelectionSet",
        selections: [
          {
            kind: "Field",
            name: { kind: "Name", value: "externalDataSourceUpdateConfigs" },
            selectionSet: {
              kind: "SelectionSet",
              selections: [
                { kind: "Field", name: { kind: "Name", value: "id" } },
...
export const EnableUpdateConfigDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "EnableUpdateConfig" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "ID" } },
...
>;
export const DisableUpdateConfigDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "DisableUpdateConfig" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "ID" } },
  ...
  definitions: [
    {
      ...
      selectionSet: {
        ...
        selections: [
          {
            kind: "Field",
            name: { kind: "Name", value: "updateAll" },
            arguments: [
              {
                kind: "Argument",
                name: { kind: "Name", value: "configId" },
...
>;
export const UserTestDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "UserTest" },
      selectionSet: {
        kind: "SelectionSet",
        selections: [
          {
...
} as unknown as DocumentNode<UserTestQuery, UserTestQueryVariables>;
