...
/** GenericData(id, data_type, data, date, float, int, json, created_at, last_update, point, polygon, postcode_data, postcode, first_name, last_name, full_name, email, phone, start_time, end_time, public_url, geocode_data, geocoder, address, title, description, image, can_display_point) */
