...
export type GetHubMapDataQuery = {
  ...
  hubByHostname?: {
    ...
    layers: Array<{
      ...
      source: { __typename?: 'SharedDataSource'; id: any }
    }>
...
export type ConstituencyStatsOverviewQuery = {
  ...
  mapReport: {
    __typename?: 'MapReport'
    id: any
    importedDataCountByConstituency: Array<{
      __typename?: 'GroupedDataCount'
      label?: string | null
      gss?: string | null
      count: number
      gssArea?: {
        ...
        mp?: {
          ...
          name: string
          photo?: { __typename?: 'DjangoImageType'; url: string } | null
          party?: { __typename?: 'PersonData'; name: string } | null
        } | null
        lastElection?: {
          __typename?: 'ConstituencyElectionResult'
          stats: {
...
export type GetConstituencyDataQuery = {
  __typename?: 'Query'
  constituency?: {
    __typename?: 'Area'
    id: string
...
export type MapReportWardStatsQuery = {
  __typename?: 'Query'
  mapReport: {
    __typename?: 'MapReport'
    id: any
    importedDataCountByWard: Array<{
      __typename?: 'GroupedDataCount'
      label?: string | null
      gss?: string | null
      count: number
...
export type MapReportCountByAreaQuery = {
  __typename?: 'Query'
  mapReport: {
    __typename?: 'MapReport'
    id: any
    importedDataCountByArea: Array<{
      __typename?: 'GroupedDataCount'
      label?: string | null
      gss?: string | null
      count: number
...
export type MapReportStatsByAreaQuery = {
  __typename?: 'Query'
  mapReport: {
    __typename?: 'MapReport'
    id: any
    importedDataByArea: Array<{
      __typename?: 'GroupedData'
      label?: string | null
      gss?: string | null
...
export type UpdateMapReportMutation = {
  ...
  updateMapReport: {
    ...
    layers: Array<{
      ...
      id: string
      name: string
      source: { __typename?: 'SharedDataSource'; id: any; name: string }
    }>
  }
}
...
export const MapReportLayersSummaryFragmentDoc = {
  kind: 'Document',
  definitions: [
    {
      kind: 'FragmentDefinition',
      name: { kind: 'Name', value: 'MapReportLayersSummary' },
      typeCondition: {
        kind: 'NamedType',
...
} as unknown as DocumentNode<MapReportLayersSummaryFragment, unknown>
export const MapReportPageFragmentDoc = {
  kind: 'Document',
  definitions: [
    {
      kind: 'FragmentDefinition',
      name: { kind: 'Name', value: 'MapReportPage' },
      typeCondition: {
        kind: 'NamedType',
        name: { kind: 'Name', value: 'MapReport' },
      },
...
} as unknown as DocumentNode<MapReportPageFragment, unknown>
...
export const ConstituencyStatsOverviewDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
            ...
            selectionSet: {
              ...
              selections: [
                { kind: 'Field', name: { kind: 'Name', value: 'id' } },
                {
                  ...
                  alias: {
                    kind: 'Name',
                    value: 'importedDataCountByConstituency',
                  },
                      ...
                      { kind: 'Field', name: { kind: 'Name', value: 'count' } },
                      {
                        ...
                        selectionSet: {
                          ...
                          selections: [
                            ...
                            {
                              kind: 'Field',
                              name: { kind: 'Name', value: 'fitBounds' },
                            },
                            {
                              kind: 'Field',
                              alias: { kind: 'Name', value: 'mp' },
                            ...
                            {
                              kind: 'Field',
                              name: { kind: 'Name', value: 'lastElection' },
                              selectionSet: {
                                kind: 'SelectionSet',
                                selections: [
                                  {
...
>
export const GetConstituencyDataDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
                    ...
                    selections: [
                      {
                        ...
                        selectionSet: {
                          ...
                          selections: [
                            ...
                            {
                              kind: 'Field',
                              name: { kind: 'Name', value: 'electorate' },
                            },
                            {
                              kind: 'Field',
            ...
            selectionSet: {
              ...
              selections: [
                { kind: 'Field', name: { kind: 'Name', value: 'id' } },
                {
                  ...
                  alias: {
                    kind: 'Name',
                    value: 'importedDataCountForConstituency',
                  },
                  name: { kind: 'Name', value: 'importedDataCountForArea' },
                  arguments: [
                    {
                      kind: 'Argument',
                      name: { kind: 'Name', value: 'analyticalAreaType' },
                        ...
                        selectionSet: {
                          ...
                          selections: [
                            ...
                            },
                            {
                              ...
                              name: {
                                kind: 'Name',
                                value: 'importedDataCountForArea',
                              },
                              arguments: [
                                {
                                  kind: 'Argument',
  ...
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'MapReportWardStats' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: {
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                {
                  kind: 'Field',
                  name: { kind: 'Name', value: 'importedDataCountByWard' },
                  selectionSet: {
                    kind: 'SelectionSet',
                    selections: [
                      { kind: 'Field', name: { kind: 'Name', value: 'label' } },
...
>
export const MapReportCountByAreaDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'MapReportCountByArea' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: {
  ...
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'MapReportStatsByArea' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: {
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                {
                  kind: 'Field',
                  name: { kind: 'Name', value: 'importedDataByArea' },
                  arguments: [
                    {
                      kind: 'Argument',
                      name: { kind: 'Name', value: 'analyticalAreaType' },
                  ...
                  selectionSet: {
                    ...
                    selections: [
                      ...
                      {
                        kind: 'Field',
                        name: { kind: 'Name', value: 'importedData' },
                      },
                      {
                        kind: 'Field',
                        name: { kind: 'Name', value: 'gssArea' },
