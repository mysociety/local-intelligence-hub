...
export type AreaLayerDataQuery = {
  __typename?: 'Query'
  points: Array<{ __typename?: 'GenericData'; json?: any | null }>
  summary?: {
    __typename?: 'DataSummary'
    aggregated: any
    metadata: {
...
export type GetMapReportQuery = {
  ...
  mapReport: {
    ...
    layers: Array<{
      ...
      id: string
      name: string
      inspectorType?: InspectorDisplayType | null
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                { kind: 'Field', name: { kind: 'Name', value: 'mapboxPaint' } },
                {
                  kind: 'Field',
  ...
  definitions: [
    {
      ...
      variableDefinitions: [
        ...
        },
        {
          ...
          variable: {
            kind: 'Variable',
            name: { kind: 'Name', value: 'boundaryType' },
          },
          type: {
            kind: 'NonNullType',
            type: {
