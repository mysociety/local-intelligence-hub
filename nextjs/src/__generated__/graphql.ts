...
export type GetHubMapDataQuery = { __typename?: 'Query', hubByHostname?: { __typename?: 'HubHomepage', id: string, organisation: { __typename?: 'Organisation', id: string, slug: string, name: string }, layers: Array<{ __typename?: 'MapLayer', id: string, name: string, visible?: boolean | null, iconImage?: string | null, mapboxPaint?: any | null, mapboxLayout?: any | null, source: { __typename?: 'SharedDataSource', id: any } }>, navLinks: Array<{ __typename?: 'HubNavLink', label: string, link: string }> } | null };
...
export type GetLocalDataQuery = { __typename?: 'Query', postcodeSearch: { __typename?: 'UnauthenticatedPostcodeQueryResponse', postcode: string, electoralCommission?: { __typename?: 'ElectoralCommissionPostcodeLookup', addresses: any, dates: Array<{ __typename?: 'ElectionDate', pollingStation: { __typename?: 'PollingStation', station?: { __typename?: 'ElectoralCommissionStation', properties?: { __typename?: 'ElectoralCommissionStationProperties', address: string, postcode: string } | null } | null } }> } | null, constituency?: { __typename?: 'Area', id: string, gss: string, name: string, fitBounds?: any | null, genericDataForHub: Array<{ __typename?: 'GenericData', id: string, title?: string | null, address?: string | null, postcode?: string | null, startTime?: any | null, publicUrl?: string | null, description?: string | null, dataType: { __typename?: 'DataType', id: string, dataSet: { __typename?: 'DataSet', externalDataSource: { __typename?: 'ExternalDataSource', dataType: DataSourceType } } } }>, samplePostcode?: { __typename?: 'PostcodesIOResult', postcode: string } | null, ppcs: Array<{ __typename?: 'Person', id: string, name: string, photo?: { __typename?: 'DjangoImageType', url: string } | null, party?: { __typename?: 'PersonData', shade?: string | null, name: string } | null, email?: { __typename?: 'PersonData', data: string } | null }> } | null } };

export type GetElectoralCommissionDataQueryVariables = Exact<{
  postcode: Scalars['String']['input'];
  addressSlug: Scalars['String']['input'];
}>;


export type GetElectoralCommissionDataQuery = { __typename?: 'Query', postcodeSearch: { __typename?: 'UnauthenticatedPostcodeQueryResponse', postcode: string, electoralCommission?: { __typename?: 'ElectoralCommissionPostcodeLookup', dates: Array<{ __typename?: 'ElectionDate', pollingStation: { __typename?: 'PollingStation', station?: { __typename?: 'ElectoralCommissionStation', properties?: { __typename?: 'ElectoralCommissionStationProperties', address: string, postcode: string } | null } | null } }> } | null } };
...
export const GetElectoralCommissionDataDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetElectoralCommissionData"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"postcode"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"addressSlug"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"postcodeSearch"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"postcode"},"value":{"kind":"Variable","name":{"kind":"Name","value":"postcode"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"postcode"}},{"kind":"Field","name":{"kind":"Name","value":"electoralCommission"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"addressSlug"},"value":{"kind":"Variable","name":{"kind":"Name","value":"addressSlug"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"dates"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"pollingStation"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"station"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"properties"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"address"}},{"kind":"Field","name":{"kind":"Name","value":"postcode"}}]}}]}}]}}]}}]}}]}}]}}]} as unknown as DocumentNode<GetElectoralCommissionDataQuery, GetElectoralCommissionDataQueryVariables>;
