        ...
        <section className='!leading-tight my-24' id='about'>
            ...
            <div className='grid sm:grid-cols-2 gap-8'>
                ...
                <div className='text-hub-primary-neutral !leading-tight text-hubxl space-y-5'>
                    <p className='text-hub-primary-800 !leading-tight text-hub2xl'>People across the UK are already taking action to tackle climate change and protect nature.</p>
                    ...
                    <p className='text-hub-primary-600'>We are united for people, climate and nature.</p>
                </div>
            </div>
        </section>
    )
